...
/Users/coding/Documents/github.com/niaoshuai/ice-demo/src/pages/Analysis/components/FusionCardTypebarChart/index.tsx usage
```jsx
...
const FusionCardTypebarChart: React.FunctionComponent<FusionCardTypebarChartProps> =
                                (props: FusionCardTypebarChartProps): JSX.Element => {
                                  const {
