...
/Users/coding/Documents/github.com/niaoshuai/ice-demo/src/pages/Analysis/components/FusionCardGroupBarChart/index.tsx usage
```jsx
...
const FusionCardGroupBarChart: React.FunctionComponent<FusionCardGroupBarChartProps> =
                                      (props: FusionCardGroupBarChartProps): JSX.Element => {
                                        const {
